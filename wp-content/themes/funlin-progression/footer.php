...
?>
				...
				<div id="copyright-divider-top"></div>				
					<div class="width-container-pro">
						<div id="copyright-text">
							<?php echo esc_html__( 'All Rights Reserved. Developed by Progression Studios', 'funlin-progression' ); ?>
						</div>
	...
	<div id="pro-scroll-top"><?php esc_html_e( 'Scroll to top', 'funlin-progression' ); ?></div>
